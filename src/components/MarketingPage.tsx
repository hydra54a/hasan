      ...
      <div className="marketing-page">
        ...
        <div className="marketing-layout"><div className="marketing-stage">
          {activeStage === 'investment' ? <section><StageHeader number="01" title="Current marketing investment" description="Connect the investment already creating demand to the lead and conversion performance captured elsewhere in this calculator." /><div className="input-grid four">
            ...
            <div className="field calculated-field"><span className="field-label">Annual leads generated</span><span className="field-hint">Synchronized with Lead Generation Impact</span><output className="calculated-value">{formatNumber(results.annualLeads)}</output></div>
            <div className="field calculated-field"><span className="field-label">Current close rate</span><span className="field-hint">Synchronized with Lead Generation Impact</span><output className="calculated-value">{formatPercent(inputs.currentCloseRate, 1)}</output></div>
            <div className="field calculated-field"><span className="field-label">Average deal value</span><span className="field-hint">Synchronized with Lead Generation Impact</span><output className="calculated-value">{formatCurrency(inputs.averageDealValue)}</output></div>
