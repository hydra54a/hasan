...
export const MODULES: { id: ModuleId; label: string; shortLabel: string }[] = [
  ...
  { id: 'lead', label: 'Lead Generation', shortLabel: 'Lead Generation' },
  { id: 'conversion', label: 'Conversion – Close Rate Improvement', shortLabel: 'Conversion' },
  { id: 'discount', label: 'Discount Reduction', shortLabel: 'Discount Reduction' },
